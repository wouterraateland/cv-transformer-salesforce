...
- `sf package version promote --package 04tgK000000AYbVQAW`
...
```
sf package install --package 04tgK000000AYbVQAW --installation-key cvt1
```

## Via browser

Go to https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK000000AYbVQAW \
Use password `cvt1`
