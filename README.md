...
- `sf package version promote --package 04tgK0000009vIPQAY`
...
```
sf package install --package 04tgK0000009vIPQAY --installation-key cvt1
```

## Via browser

Go to https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK0000009vIPQAY \
Use password `cvt1`
