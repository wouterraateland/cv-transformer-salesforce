...
- `sf package version promote --package 04tgK0000006kUnQAI`
...
```
sf package install --package 04tgK0000006kUnQAI --installation-key cvt1
```

## Via browser

Go to https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK0000006kUnQAI \
Use password `cvt1`
