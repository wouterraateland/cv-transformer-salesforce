...
- `sf package version promote --package 04tgK0000007x3NQAQ`
...
```
sf package install --package 04tgK0000007x3NQAQ --installation-key cvt1
```

## Via browser

Go to https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK0000007x3NQAQ \
Use password `cvt1`
