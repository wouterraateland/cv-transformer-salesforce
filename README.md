...
- `sf package version promote --package 04tgK000000A3cXQAS`
...
```
sf package install --package 04tgK000000A3cXQAS --installation-key cvt1
```

## Via browser

Go to https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK000000A3cXQAS \
Use password `cvt1`
