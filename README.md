...
- `sf package version promote --package 04tgK0000005MkfQAE`
...
```
sf package install --package 04tgK0000005MkfQAE --installation-key cvt1
```

## Via browser

Go to https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK0000005MkfQAE \
Use password `cvt1`
